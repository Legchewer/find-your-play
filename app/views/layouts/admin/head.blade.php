<head>
    <title>Find your Play - Admin</title>
    ...
    {{ HTML::style("//cdnjs.cloudflare.com/ajax/libs/font-awesome/{$version['fa']}/css/font-awesome.min.css") }}


    {{ HTML::style("//cdnjs.cloudflare.com/ajax/libs/select2/{$version['select']}/select2.min.css") }}
